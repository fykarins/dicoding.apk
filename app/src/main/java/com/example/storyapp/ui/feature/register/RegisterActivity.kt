...
import com.example.storyapp.ui.feature.factory.RegisterViewModelFactory
import com.example.storyapp.ui.feature.login.LoginActivity
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun observeViewModel() {
        ...
        registerViewModel.registerResult.observe(this, Observer { storyResult ->
            when (storyResult) {
                ...
                is StoryResult.Loading -> {
                    ...
                    Log.w("RegisterActivity", "Unexpected StoryResult: $storyResult")
                }
            }
        })
    }
